...
Contributions:
- Implemented all helper C functions (get_r, get_g, get_b, get_a, make_pixel, compute_index, is_in_ellipse)
...
- implemented all assembly helper functions
- final testing and readability of assembly complement and transpose
